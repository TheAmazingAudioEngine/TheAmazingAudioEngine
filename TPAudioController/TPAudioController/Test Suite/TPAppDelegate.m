...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.audioController = [[[TPAudioController alloc] initWithAudioDescription:[TPAudioController interleaved16BitStereoAudioDescription] inputEnabled:YES useVoiceProcessing:NO] autorelease];
